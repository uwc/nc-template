<?php
/**
 * NC Template Customizer functionality
 *
 * @package NC Template
 */
 ...
 *
 * @see nc_template_header_style()
 */
function nc_template_custom_header_and_background() {
	$color_scheme             = nc_template_get_color_scheme();
	 ...
	 * }
	 */
	add_theme_support( 'custom-background', apply_filters( 'nc_template_custom_background_args', array(
		'default-color' => $default_background_color,
	) ) );

	/**
	 * Filter the arguments used when adding 'custom-header' support in NC Template.
	 *
	 * @param array $args {
...
add_action( 'after_setup_theme', 'nc_template_custom_header_and_background' );

if ( ! function_exists( 'nc_template_header_style' ) ) :
/**
 * Styles the header text displayed on the site.
 *
 * Create your own nc_template_header_style() function to override in a child theme.
 *
 * @see nc_template_custom_header_and_background().
 */
function nc_template_header_style() {
	...
	?>
	<style type="text/css" id="nc-template-header-css">
		.site-branding {
			margin: 0 auto 0 0;
		}
...
function twentysixteen_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( 'color_scheme', array(
		'label'    => __( 'Base Color Scheme', 'nc-template' ),
		'section'  => 'colors',
		'type'     => 'select',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'page_background_color', array(
		'label'       => __( 'Page Background Color', 'nc-template' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'link_color', array(
		'label'       => __( 'Link Color', 'nc-template' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'main_text_color', array(
		'label'       => __( 'Main Text Color', 'nc-template' ),
		'section'     => 'colors',
	) ) );
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'secondary_text_color', array(
		'label'       => __( 'Secondary Text Color', 'nc-template' ),
		'section'     => 'colors',
	) ) );
}
